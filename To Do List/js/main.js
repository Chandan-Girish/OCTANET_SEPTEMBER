...
function createLIS(val,id){
    ...
    li.innerHTML = `<p class="text">${val}</p><i class="bx bxs-edit bx-sm"></i><i class="bx bx-check bx-sm"></i><i class="bx bxs-trash bx-sm"></i>`;
